...
function Juvignac () {
    return (
        <div class="content">
        <div class="title">
            <h4>Refonte du site <a href="http://juvignac-rc.fr/" rel="noreferrer">Juvignac (V1)</a><br/></h4>
            <h3>Juvignac-rc (V3)</h3>
        </div>
        <div id="presentation">
        <a href="http://juvignac-rc.fr/V3/" target="_blank" rel="noreferrer">
            ...
            La refonte du site <a href="http://juvignac-rc.fr/" target="_blank" rel="noreferrer">Juvignac-rc</a> devait se faire via Wordpress en équipe de 3 personnes.
            </p>
        </div>
    </div>
    )
